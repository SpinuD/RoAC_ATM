...
namespace ROARMY
{
    public partial class Personal_login : System.Web.UI.Page
    {
        ...
        protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
        {
            ...
            string querry = "SELECT Username,Passwod  FROM Personal WHERE Username='" + Login1.UserName + "' and Passwod='" + Login1.Password + "' and Functie='Bucatar'";
